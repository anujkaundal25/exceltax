  ...
  return (
    <section className="py-16 px-6 lg:px-20 bg-[url('/approach/approach-bg.jpg')] bg-cover bg-center">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div className="block lg:hidden order-1 bg-white p-5 shadow-lg border-l-5 border-[#f38b0b] rounded-r-2xl">
        ...
        <div className="top-24 order-2 lg:order-none">
          <div className="relative">
            ...
            <div className="hidden lg:block absolute bottom-4 left-4 bg-white p-5 shadow-lg max-w-lg border-l-5 border-[#f38b0b]">
              <h3 className="text-xl font-semibold mb-2 text-[#f38b0b]">Our Approach</h3>
              <p className="text-[#0c2c68]">
                By acting as both your company's tax advisor and lawyer, and by
                taking a systemic view of your business (One-Stop Shop
        ...
        <div className="flex flex-col justify-center order-3 lg:order-none">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0c2c68] leading-tight mb-6">
