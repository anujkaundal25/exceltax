            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-xs font-bold text-[#0c2c68] uppercase tracking-wider mb-2">Nom Complet</label>
                    <input 
                      type="text" 
                      name="name"
                      value={formData.name}
                  ...
                  <div>
                    <label className="block text-xs font-bold text-[#0c2c68] uppercase tracking-wider mb-2">Adresse Email</label>
                    <input 
                      type="email" 
                      name="email"
                ...
                <div>
                  <label className="block text-xs font-bold text-[#0c2c68] uppercase tracking-wider mb-2">Sujet</label>
                  <input 
                    type="text" 
                    name="subject"
                ...
                <div>
                  <label className="block text-xs font-bold text-[#0c2c68] uppercase tracking-wider mb-2">Détails du message</label>
                  <textarea 
                    rows="4" 
                    name="message"
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="text-xs text-slate-300 block font-medium">Ligne Téléphonique</span>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="text-xs text-slate-300 block font-medium">Correspondance Numérique</span>
                    <a href="mailto:direction@exceltax.org" className="text-sm font-bold hover:text-[#f38b0b] transition-colors">direction@exceltax.org</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="text-xs text-slate-300 block font-medium">Adresse Physique</span>
                    <p className="text-sm font-bold leading-snug">EXCELTAX-ONG Immeuble NJOH, Carrefour BEN DECCA, PK12</p>
                  </div>
                </div>
